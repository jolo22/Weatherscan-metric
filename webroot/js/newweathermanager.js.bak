    ...
    data.forEach((ajaxedLoc, i) => {
        ...
        if (ajaxedLoc == null) {
          ...
          if (ajaxedLoc["v3-wx-observations-current"] == null) {
            ...
            weatherLocscc.gust = ((ajaxedLoc["v3-wx-observations-current"].windGust!=undefined) ? ajaxedLoc["v3-wx-observations-current"].windGust + " km/h": "none")
  ...
  $.getJSON(url, function(data) {
        ...
        if (ajaxedLoc == null) {
          ...
          if (ajaxedLoc["v3-wx-observations-current"] == null) {
            ...
            weatherInfo.currentCond.sidebar.gust = ((ajaxedLoc["v3-wx-observations-current"].windGust!=undefined) ? ajaxedLoc["v3-wx-observations-current"].windGust + " km/h" : "none")
